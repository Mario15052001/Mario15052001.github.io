...
<body>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Contattaci</h1>
          </div>
        </div>
            ...
            <div class="col-md-7">
              <form class="form-a contactForm" action="" method="post" role="form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <button type="submit" value="Invia Email" class="btn btn-a">Send Message</button>
                  </div>
                </div>
              </form>
            </div>
  ...
  <script src="contactform/contactform.js"><z/script>
